...
abstract contract ERC721Derived is Context, ERC165, IERC721, IERC721Metadata {
     ...
     *
     * @param colltionName The name to set.
     * @param colltionSymbol The symbol to set.
     */
    function __ERC721_Init(
        string calldata colltionName,
        string calldata colltionSymbol
    ) internal {
        _name = colltionName;
        _symbol = colltionSymbol;
    }
    ...
    function approve(address to, uint256 tokenId) public virtual override {
        address owner = ERC721Derived.ownerOf(tokenId);
    ...
    function _transfer(
        ...
        require(
            ERC721Derived.ownerOf(tokenId) == from,
    ...
    function _approve(address to, uint256 tokenId) internal virtual {
        ...
        emit Approval(ERC721Derived.ownerOf(tokenId), to, tokenId);
    }
